...
var tableLeast = document.getElementById("leastEngaged");
...
totalMissVotedPartyList.sort(compare);
...
function leastAtt(x) {
  ...
  for (i = lenght - 1; i > (lenght - tenPrct); i--) {
    ...
    if ((x["results"][0]["members"][(lenght - tenPrct)]["missed_votes_pct"]) != (x["results"][0]["members"][(lenght - tenPrct) + 1]["missed_votes_pct"])) {
      ...
      for (j = 0; j < 3; j++) {
        ...
        if (j == 1) {
          ...
          newTd.setAttribute("column", 1);
          newTr.appendChild(newTd);
          newTd.innerHTML = (x["results"][0]["members"][i]["missed_votes"]);
        ...
        if (j == 2) {
          ...
          newTd.setAttribute("column", 1);
          newTr.appendChild(newTd);
          newTd.innerHTML = (x["results"][0]["members"][i]["missed_votes_pct"]);


        }
      }

    } else if ((x["results"][0]["members"][(lenght - tenPrct)]["missed_votes_pct"]) == (x["results"][0]["members"][(lenght - tenPrct) + 1]["missed_votes_pct"])) {
...
function mostAtt(x) {
  ...
  for (i = 0; i < tenPrct ; i++) {
    ...
    if ((x["results"][0]["members"][(tenPrct)]["missed_votes_pct"]) != (x["results"][0]["members"][tenPrct + 1]["missed_votes_pct"])) {
    ...
    } else if ((x["results"][0]["members"][tenPrct]["missed_votes_pct"]) == (x["results"][0]["members"][tenPrct + 1]["missed_votes_pct"])) {
...
if (title[0].innerText == "Senate attendance page") {
  leastAtt(data);
mostAtt(data);
} else {
