...
var statistics = {
  ...
  Republicans: "0",
  Independant: "0",
  RepublicansVotedWithPrty: "0",
  DemocratsVotedWithPrty: "0",
  IndependantsVotedWithPrty: "0",
}
...
var tableLeast = document.getElementById("leastLoyal");
...
function createList(x) {
  for (i = 0; i < lenght; i++) {
    if (x["results"][0]["members"][i]["party"] == "R") {
      RepList.push(data["results"][0]["members"][i]["last_name"])
    } else if (x["results"][0]["members"][i]["party"] == "D") {
      DemList.push(data["results"][0]["members"][i]["last_name"])
    } else if (x["results"][0]["members"][i]["party"] == "I") {
      IndList.push(data["results"][0]["members"][i]["last_name"])
    }
  }
}
...
function createVotedPartyList(x) {
  for (i = 0; i < lenght; i++) {
    if (x["results"][0]["members"][i]["party"] == "R") {
      RepVotedPartyList.push(data["results"][0]["members"][i]["votes_with_party_pct"])
    } else if (x["results"][0]["members"][i]["party"] == "D") {
      DemVotedPartyList.push(data["results"][0]["members"][i]["votes_with_party_pct"])
    } else if (x["results"][0]["members"][i]["party"] == "I") {
      IndVotedPartyList.push(data["results"][0]["members"][i]["votes_with_party_pct"])
    }
  }
}

createVotedPartyList(data);
...
var avePartyVotedRep = addingArray(RepVotedPartyList) / (RepVotedPartyList.length + 1);
var sum = 0;
var avePartyVotedDem = addingArray(DemVotedPartyList) / (DemVotedPartyList.length + 1);
var sum = 0;
var avePartyVotedInd = addingArray(IndVotedPartyList) / (IndVotedPartyList.length + 1);
...
var tenPrct = Math.ceil(lenght / 10);
...
function leastLoy(x) {
    ...
    for (i = 0; i < tenPrct ; i++) {
      ...
      if ((x["results"][0]["members"][(tenPrct)]["votes_with_party_pct"]) != (x["results"][0]["members"][tenPrct + 1]["votes_with_party_pct"])) {
        ...
        for (j = 0; j < 4; j++) {
          ...
          if (j == 1) {
            ...
            newTd.setAttribute("column", 1);
            newTr.appendChild(newTd);
            newTd.innerHTML = ((Math.ceil((x["results"][0]["members"][i]["total_votes"]*x["results"][0]["members"][i]["votes_with_party_pct"])/100)));
      ...
      } else if ((x["results"][0]["members"][tenPrct]["votes_with_party_pct"]) == (x["results"][0]["members"][tenPrct + 1]["votes_with_party_pct"])) {
...
function mostLoy(x) {
  ...
  for (i = lenght - 1; i > (lenght - tenPrct); i--) {

    if ((x["results"][0]["members"][(lenght - tenPrct)]["votes_with_party_pct"]) != (x["results"][0]["members"][(lenght - tenPrct) + 1]["votes_with_party_pct"])) {
    ...
    } else if ((x["results"][0]["members"][(lenght - tenPrct)]["votes_with_party_pct"]) == (x["results"][0]["members"][(lenght - tenPrct) + 1]["votes_with_party_pct"])) {
