...
var pre = document.getElementById("senate-data");
var table = document.getElementById("table");
var lenght = data["results"][0]["members"].length;
var HOS = data["results"][0]["chamber"];
    ...
    for (i = 0; i < lenght; i++) {
      ...
      for (j = 0; j < 5; j++) {
        ...
        if (j == 0) {
          ...
          if ((x["results"][0]["members"][i]["middle_name"]) != null) {
            newA.innerHTML = (x["results"][0]["members"][i]["first_name"]) + " " + (x["results"][0]["members"][i]["middle_name"]) + " " + (x["results"][0]["members"][i]["last_name"]);
            newA.setAttribute("href", x["results"][0]["members"][i]["api_uri"])
          } else {
            newA.innerHTML = (x["results"][0]["members"][i]["first_name"]) + " " + (x["results"][0]["members"][i]["last_name"]);
            newA.setAttribute("href", x["results"][0]["members"][i]["api_uri"])
          }
          ...
          newTr.appendChild(newTd);
          newTd.innerHTML = x["results"][0]["members"][i]["party"];

        } else if (j == 2) {
          var newTd = document.createElement("td");
          newTd.setAttribute("column", 3);
          newTr.appendChild(newTd);
          newTd.innerHTML = x["results"][0]["members"][i]["state"];

        } else if (j == 3) {
          var newTd = document.createElement("td");
          newTd.setAttribute("column", 4);
          newTr.appendChild(newTd);
          newTd.innerHTML = x["results"][0]["members"][i]["seniority"];

        } else if (j == 4) {
          var newTd = document.createElement("td");
          newTd.setAttribute("column", 5);
          newTr.appendChild(newTd);
          newTd.innerHTML = x["results"][0]["members"][i]["votes_with_party_pct"];
...
function filterDem(x) {
 ...
 for (i = 0; i < lenght; i++) {
    ...
    for (j = 0; j < 5; j++)
      if (x["results"][0]["members"][i]["party"] == "D") {
...
function filterInd(x) {
 ...
 for (i = 0; i < lenght; i++) {
    ...
    for (j = 0; j < 5; j++)
      if (x["results"][0]["members"][i]["party"] == "I") {
...
function filterRepDem(x) {
 ...
 for (i = 0; i < lenght; i++) {
    ...
    for (j = 0; j < 5; j++)
      if (x["results"][0]["members"][i]["party"] == "R" || x["results"][0]["members"][i]["party"] == "D" )  {
...
function filterRepInd(x) {
 ...
 for (i = 0; i < lenght; i++) {
    ...
    for (j = 0; j < 5; j++)
      if (x["results"][0]["members"][i]["party"] == "R" || x["results"][0]["members"][i]["party"] == "I" ) {
...
function filterDemInd(x) {
 ...
 for (i = 0; i < lenght; i++) {
    ...
    for (j = 0; j < 5; j++)
      if (x["results"][0]["members"][i]["party"] == "D" || x["results"][0]["members"][i]["party"] == "I" ) {
...
document.getElementById("filter").addEventListener("change", function () {
  if (document.getElementById("checkRep").checked == true && document.getElementById("checkDem").checked == false && document.getElementById("checkInd").checked == false) {
    table.innerHTML = "";
    filterRep(data)
  }
  else if (document.getElementById("checkRep").checked == false && document.getElementById("checkDem").checked == true && document.getElementById("checkInd").checked == false) {
    table.innerHTML = "";
    filterDem(data)
  }
  else if (document.getElementById("checkRep").checked == false && document.getElementById("checkDem").checked == false && document.getElementById("checkInd").checked == true) {
    table.innerHTML = "";
    filterInd(data)
  }

  else if (document.getElementById("checkRep").checked == true && document.getElementById("checkDem").checked == true && document.getElementById("checkInd").checked == false) {
    table.innerHTML = "";
    filterRepDem(data);
  }

  else if (document.getElementById("checkRep").checked == true && document.getElementById("checkDem").checked == false && document.getElementById("checkInd").checked == true) {
    table.innerHTML = "";
    filterRepInd(data);
  }

  else if (document.getElementById("checkRep").checked == false && document.getElementById("checkDem").checked == true && document.getElementById("checkInd").checked == true) {
    table.innerHTML = "";
    filterDemInd(data);
  }

  else if (document.getElementById("checkRep").checked == true && document.getElementById("checkDem").checked == true && document.getElementById("checkInd").checked == true) {
    table.innerHTML = "";
    HouOrSen(data);
  }

  else if (document.getElementById("checkRep").checked == false && document.getElementById("checkDem").checked == false && document.getElementById("checkInd").checked == false) {
    table.innerHTML = "";
    HouOrSen(data)
  }
})
